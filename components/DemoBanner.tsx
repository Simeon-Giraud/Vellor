...
export default function DemoBanner() {
  return (
    <div className="mx-6 md:mx-8 mt-6 p-4 bg-purple-500/5 border border-purple-500/15 rounded-2xl flex items-center justify-between animate-fade-in-down">
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm text-purple-800 dark:text-purple-200/90 font-medium tracking-tight">
