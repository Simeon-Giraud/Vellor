...
export default async function HomePage() {
  ...
  return (
    <main style={{ background: "var(--color-surface)", minHeight: "100vh", position: "relative", overflowX: "hidden" }}>
      ...
      <section id="why-geo" style={{ padding: "120px 24px", background: "var(--color-fg)", borderTop: "1px solid var(--color-border)", borderBottom: "1px solid var(--color-border)", color: "var(--color-bg)", textAlign: "center" }}>
