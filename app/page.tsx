...
export default async function HomePage() {
  ...
  return (
    <main style={{ background: "var(--color-surface)", minHeight: "100vh", position: "relative" }}>
      {/* Ambient Radial Glow */}
      <div
        style={{
          position: "absolute",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              {isSignedIn ? (
                ...
                <>
                  <Link href="/sign-in" style={{ fontSize: 14, color: "var(--color-fg-muted)", textDecoration: "none", padding: "8px 12px" }}>Sign in</Link>
      ...
      >
        <div>
          ...
          <p
            style={{ fontSize: 18, color: "var(--color-fg-muted)", lineHeight: 1.55, maxWidth: 440, marginBottom: 32 }}
          >
          ...
          <p style={{ fontSize: 12, color: "var(--color-fg-subtle)", marginTop: 16 }}>
        ...
        <div className="card-white" style={{ padding: 20, borderRadius: 24, overflow: "hidden" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10, marginBottom: 16 }}>
            {[
              ...
              <div key={m.label} style={{ background: "var(--color-surface-2)", borderRadius: 14, padding: "12px 14px" }}>
                <p style={{ fontSize: 10, color: "var(--color-fg-subtle)", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 4 }}>{m.label}</p>
                <p style={{ fontSize: 22, fontWeight: 700, color: "var(--color-fg)", fontFamily: "var(--font-mono)", letterSpacing: "-0.03em" }}>{m.value}</p>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 16 }}>
            {MOCK_DATA.map(d => (
              <div key={d.engine} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <span style={{ fontSize: 12, color: "var(--color-fg-muted)", width: 74, flexShrink: 0 }}>{d.engine}</span>
                ...
                <span style={{ fontSize: 12, fontFamily: "var(--font-mono)", color: "var(--color-fg)", width: 32, textAlign: "right" }}>{d.score}%</span>
          ...
          <div style={{ background: "var(--color-surface-2)", borderRadius: 14, padding: "12px 14px" }}>
            <p style={{ fontSize: 10, color: "var(--color-fg-subtle)", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 6 }}>Latest run</p>
            <p style={{ fontSize: 13, color: "var(--color-fg)", marginBottom: 8, lineHeight: 1.4 }}>
              "What are the best AI monitoring tools for B2B brands?"
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <span style={{ fontSize: 11, color: "#34c759", background: "rgba(52, 199, 89, 0.15)", borderRadius: 999, padding: "2px 8px", fontWeight: 500 }}>✓ 3/3 engines</span>
              <span style={{ fontSize: 11, color: "var(--color-fg-subtle)" }}>4 min ago</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" style={{ maxWidth: 1200, margin: "0 auto", padding: "100px 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          <p style={{ fontSize: 13, fontWeight: 600, color: "var(--color-fg-subtle)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 12 }}>
            How it works
          </p>
          <h2 style={{ fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 700, letterSpacing: "-0.025em", color: "var(--color-fg)", lineHeight: 1.1 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: 16 }}>
          ...
          <div className="card-white" style={{ gridColumn: "span 8", padding: 36 }}>
            ...
            <h3 style={{ fontSize: 22, fontWeight: 600, letterSpacing: "-0.02em", color: "var(--color-fg)", marginBottom: 8 }}>
              Track every AI engine
            </h3>
            <p style={{ fontSize: 15, color: "var(--color-fg-muted)", lineHeight: 1.55, maxWidth: 440 }}>
            ...
            <div style={{ marginTop: 28, display: "flex", flexDirection: "column", gap: 10 }}>
              {MOCK_DATA.map(d => (
                <div key={d.engine} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <span style={{ fontSize: 12, color: "var(--color-fg-muted)", width: 70, flexShrink: 0 }}>{d.engine}</span>
                  <div className="stat-bar-track" style={{ flex: 1 }}>
                    <div className="stat-bar-fill" style={{ width: `${d.score}%`, background: ENGINE_COLORS[d.engine] }} />
                  </div>
                  <span style={{ fontSize: 12, fontFamily: "var(--font-mono)", color: "var(--color-fg)", width: 30, textAlign: "right" }}>{d.score}%</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="card-white" style={{ gridColumn: "span 4", padding: 36 }}>
            ...
            <p style={{ fontSize: 15, color: "var(--color-fg-muted)", lineHeight: 1.55 }}>
              ...
              {[32, 44, 38, 51, 58, 55, 61, 74, 71, 80, 78, 88].map((h, i) => (
                <div
                  ...
                  style={{
                    flex: 1,
                    height: `${h}%`,
                    background: i === 11 ? "#0071e3" : "var(--color-surface-3)",
      ...
      <section id="how-it-works" style={{ maxWidth: 1200, margin: "0 auto", padding: "100px 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 72 }}>
          ...
          <h2 style={{ fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 700, letterSpacing: "-0.025em", color: "var(--color-fg)", lineHeight: 1.1, marginBottom: 16 }}>
            From setup to insights<br />in minutes.
          </h2>
          <p style={{ fontSize: 17, color: "var(--color-fg-muted)", lineHeight: 1.6, maxWidth: 480, margin: "0 auto" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="card-white" style={{ padding: 40, display: "flex", flexDirection: "column", gap: 20 }}>
            <div style={{ display: "flex", alignItems: "flex-start", gap: 20 }}>
              ...
              <div>
                ...
                <h3 style={{ fontSize: 20, fontWeight: 600, letterSpacing: "-0.02em", color: "var(--color-fg)", marginBottom: 10 }}>
            ...
            <div style={{ background: "var(--color-surface-2)", borderRadius: 14, padding: "16px 20px", display: "flex", flexDirection: "column", gap: 8 }}>
              <p style={{ fontSize: 12, color: "var(--color-fg-subtle)", fontWeight: 500, letterSpacing: "0.04em", textTransform: "uppercase" }}>Project setup</p>
              {["Brand name: Acme Corp", "Category: B2B SaaS", "Competitors: Rival A, Rival B"].map(item => (
                <div key={item} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ fontSize: 13, color: "var(--color-fg)", fontFamily: "var(--font-mono)" }}>{item}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="card-white" style={{ padding: 40, display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ background: "var(--color-surface-2)", borderRadius: 14, padding: "16px 20px" }}>
              <p style={{ fontSize: 12, color: "var(--color-fg-subtle)", fontWeight: 500, letterSpacing: "0.04em", textTransform: "uppercase", marginBottom: 10 }}>Example prompt</p>
              <p style={{ fontSize: 13, color: "var(--color-fg)", lineHeight: 1.5, fontStyle: "italic", marginBottom: 10 }}>
          ...
          <div className="card-white" style={{ padding: 40, display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ background: "var(--color-surface-2)", borderRadius: 14, padding: "16px 20px" }}>
              <p style={{ fontSize: 12, color: "var(--color-fg-subtle)", fontWeight: 500, letterSpacing: "0.04em", textTransform: "uppercase", marginBottom: 12 }}>Your scores</p>
          ...
          <div className="card-white" style={{ padding: 40, display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ background: "var(--color-surface-2)", borderRadius: 14, padding: "16px 20px", display: "flex", flexDirection: "column", gap: 10 }}>
              <p style={{ fontSize: 12, color: "var(--color-fg-subtle)", fontWeight: 500, letterSpacing: "0.04em", textTransform: "uppercase" }}>Insights for you</p>
              {[
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <span style={{ fontSize: 13, color: "var(--color-fg)", flex: 1, lineHeight: 1.4 }}>{insight.text}</span>
                  <span style={{ fontSize: 11, fontWeight: 500, color: insight.tag.startsWith("+") ? "#34c759" : "var(--color-fg-muted)", background: insight.tag.startsWith("+") ? "rgba(52, 199, 89, 0.15)" : "var(--color-surface-3)", borderRadius: 999, padding: "2px 8px", flexShrink: 0 }}>{insight.tag}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{ textAlign: "center", marginTop: 56 }}>
          <p style={{ fontSize: 15, color: "var(--color-fg-muted)", marginBottom: 20 }}>
      ...
      <section id="engines" style={{ maxWidth: 1200, margin: "0 auto", padding: "100px 24px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          <div>
            ...
            <h2 style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.6rem)", fontWeight: 700, letterSpacing: "-0.025em", color: "var(--color-fg)", lineHeight: 1.1, marginBottom: 20 }}>
              Three engines.<br />One unified view.
            </h2>
            <p style={{ fontSize: 17, color: "var(--color-fg-muted)", lineHeight: 1.6, marginBottom: 32, maxWidth: 400 }}>
              ...
              >
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                    <span style={{ fontSize: 15, fontWeight: 600, color: "var(--color-fg)" }}>{e.name}</span>
                    <span style={{ fontSize: 15, fontWeight: 700, fontFamily: "var(--font-mono)", color: "var(--color-fg)" }}>{e.share}</span>
                  </div>
                  <div className="stat-bar-track">
                    <div className="stat-bar-fill" style={{ width: `${e.bar * 1.2}%`, background: ENGINE_COLORS[e.name] }} />
                  </div>
                  <p style={{ fontSize: 12, color: "var(--color-fg-subtle)", marginTop: 6 }}>{e.note}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section
        ...
        style={{ padding: "100px 24px", marginTop: 0 }}
      >
        <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontSize: 13, fontWeight: 600, color: "var(--pricing-fg-subtle)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 16 }}>
            Pricing
          </p>
          <h2 style={{ fontSize: "clamp(2rem, 4.5vw, 3.2rem)", fontWeight: 700, letterSpacing: "-0.03em", color: "var(--pricing-fg)", lineHeight: 1.08, marginBottom: 16 }}>
            Transparent plans.<br />No surprises.
          </h2>
          <p style={{ fontSize: 18, color: "var(--pricing-fg-muted)", lineHeight: 1.55, marginBottom: 40 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", marginBottom: 24 }}>
            ...
            {!isSignedIn && (
              <Link href="/sign-up" className="btn-ghost" style={{ color: "var(--pricing-fg)", borderColor: "var(--pricing-border)" }}>
                Start free trial
              </Link>
            )}
          </div>

          <p style={{ fontSize: 13, color: "var(--pricing-fg-subtle)", fontFamily: "var(--font-mono)" }}>
      ...
      {/* ── Footer ── */}
      <footer className="footer-section" style={{ padding: "32px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <Link href="/" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
            <Logo className="w-6 h-6" invert />
            <span style={{ fontWeight: 600, fontSize: 14, color: "var(--footer-fg)" }}>Vellor</span>
          </Link>
          <p style={{ fontSize: 13, color: "var(--footer-fg-muted)" }}>© 2025 Vellor. All rights reserved.</p>
