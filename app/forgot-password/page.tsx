    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-[#f5f5f7]">
      ...
      <div className="w-full max-w-md animate-fade-in-up relative z-10">
        ...
        <div className="card-white rounded-2xl p-8 border border-black/[0.06] shadow-xl bg-white">
          <h1 className="text-2xl font-bold text-[#1d1d1f] tracking-tight mb-2">Reset password</h1>
          ...
          {success ? (
            <div className="text-center py-6">
              ...
              <p className="text-zinc-600 text-sm">If an account exists for <span className="text-zinc-900 font-medium">{email}</span>, you will receive a password reset link shortly.</p>
            </div>
          ) : (
          ...
          <div className="mt-6 text-center text-sm">
            <Link href="/sign-in" className="text-[#0071e3] hover:underline transition-colors font-medium flex items-center justify-center gap-1">
